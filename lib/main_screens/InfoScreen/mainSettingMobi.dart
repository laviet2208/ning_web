      ...
      child: ListView(
        children: [
          ...
          Padding(
            ...
            child: ButtonType1(Height: 60, Width: screenWidth - 140, color: Colors.redAccent, radiusBorder: 30, title: "Edit profile", fontText: "arial", colorText: Colors.white,
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder:(context) => viewAccMobi()));
                }),
          ),
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder:(context) => walletMobiScreen()));
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                voucherSelect.clear();
                Navigator.push(context, MaterialPageRoute(builder:(context) => VoucherScreenMobi()));
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                voucherSelect.clear();
                Navigator.push(context, MaterialPageRoute(builder:(context) => ExitingorderMobiScreen()));
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder:(_) => changeLanguage()));
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder:(context) => IntroductionMobi()));
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () async {
                await _auth.signOut();
                Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => FirstLoad()), (route) => false,);
              },
              child: Container(
                height: 60,
                decoration: BoxDecoration(
