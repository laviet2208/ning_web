...
class _MainMenuScreenState extends State<MainMenuScreen> {
  ...
  void getFeaturedData() {
    ...
    reference.child("product").onValue.listen((event) {
      final dynamic product = event.snapshot.value; // sử dụng kiểu dữ liệu dynamic
      if (product != null && product is Map<String, dynamic>) { // kiểm tra kiểu dữ liệu
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            Navigator.push(context, MaterialPageRoute(builder:(context) => proDuctDetailScreen(product: dataFiveStar[index])));
                                          },
